                ...
                if (m != null) {
                    ...
                    if (m.Member.SymbolKind == SymbolKind.Event) {
                        if (n is EventDeclaration ed) {
                            if (ed.GetSymbol () is IEntity r)
                                id = r.GetIdString ();
                            return "c-ed";
                        }
                        if (n is CustomEventDeclaration ed2) {
                            if (ed2.GetSymbol () is IEntity r)
                                id = r.GetIdString ();
                            return "c-ed";
                        }
                        return "c-er";
